...
static const Rule rules[] = {
   ...
   */
  /* class         instance    title                tags-mask  isfloating  centered  monitor  ignore-move-request grab-on-urgent scratch-key cant-be-swallowed is-term*/
  { "st-256color", NULL,       NULL,                0,         0,          0,          -1,      0,                  1,             0,          0,                1},
  { "popupterm",   NULL,       NULL,                0,         1,          0,          -1,      0,                  1,             0,          1,                0},
  { "scratchpad",  NULL,       NULL,                0,         1,          0,          -1,      0,                  1,            'S',         0,                1},
  { "floatterm",   NULL,       NULL,                0,         1,          0,          -1,      0,                  1,            'T',         0,                1},
  { NULL,          NULL,       "st-vimmode",        0,         0,          0,          -1,      0,                  1,             0,          0,                0},
  { "net-runelite-client-RuneLite",     NULL, NULL, 1,         1,          1,          -1,      1,                  1,             0,          0,                0},
  { "net-runelite-launcher-Launcher",   NULL, NULL, 1,         1,          1,          -1,      1,                  1,             0,          0,                0},
  { NULL, NULL, "Event Tester",                     0,         0,          0,          -1,      0,                  1,             0,          1,                0},
};
